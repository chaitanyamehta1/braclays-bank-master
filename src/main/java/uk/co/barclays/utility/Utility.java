...
public class Utility extends BasePage {
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/uk/co/barclays/screenshoot/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/uk/co/barclays/screenshoot/" + screenshotName + dateName + ".png";
